...
with(this){return _c('ul',[_c('li',[_v("can save address book data, task list data and user preference data in JSON format, and read\nthem back into corresponding objects.")]),_v(" "),_c('li',[_v("inherits from AddressBookStorage, TaskListStorage and UserPrefStorage, which means it can be\ntreated as one of the three classes (if only the functionality of only one is needed).")]),_v(" "),_c('li',[_v("depends on some classes in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" component (because the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Storage")]),_v(" component's job is to\nsave/retrieve objects that belong to the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(")")])])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"proposed-grouping-feature"}},[_v("[Proposed] Grouping Feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#proposed-grouping-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The proposed grouping mechanism is facilitated by "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("GroupedUniquePersonList")]),_v(". It extends "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UniquePersonList")]),_v(" with task that are linked between the people of the same group. Additionally, it implements the following operations:")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("GroupedUniquePersonList#assignTask(Task)")]),_v(" - Add task to everyone in the group")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("GroupedAddressBook#markTask(Index)")]),_v(" - Mark task of everyone in the group")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("GroupedAddressBook#unmarkTask(Index)")]),_v(" - Unmark task of everyone in the group")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("These operations are exposed in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" interface as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#assignTaskToGroup(String, Task)")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#markTaskOfGroup(String, Index)")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#unmarkTaskofGroup(String, Index)")]),_v(" respectively.")])}
},function anonymous(
) {
with(this){return _c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("GroupedUniquePersonList")]),_v(" adds a new string called "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("groupName")]),_v(" to label each of their groups.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("A new list of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("GroupedUniquePersonList")]),_v(" will be added to the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" interface.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("To add to the list of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("GroupedUniquePersonList")]),_v(", the Model interface includes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#addGroup(String, List<Person>)")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#addListOfGroups(List<Group>)")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('p',[_v("To remove to the list of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("GroupedUniquePersonList")]),_v(", the Model interface includes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#removeGroup(String)")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('p',[_v("New operation are exposed in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" interface are "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#addPersonToGroup(String, Person)")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#removePersonFromGroup(String, Person)")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#deleteAssignedTaskGroup(String, Task)")]),_v(" which would call "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UniquePersonList#add(Person)")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UniquePersonList#remove(Person)")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UniquePersonList#deleteAssignedTask(Person)")]),_v("respectively.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 1. The user launches the application for the first time. The list of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("GroupedUniquePersonList")]),_v(" will be empty if there are no groups stored in the storage.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 2. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("group gn/2103T gp/Ivan gp/Greg gp/Dave")]),_v(" command to group Ivan, Greg and Dave from the displayed person list to one group. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("group")]),_v(" command calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#addGroup(String, List<Person>)")]),_v(", which creates a new group with that contains the list of people that was indicated by the user.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 3. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("assigngroup gn/2103T gt/Task 1")]),_v(" command to assign a task named \"Task 1\" to the group named \"2103T\" from the group list. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("assigngroup")]),_v(" command calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#assignTaskToGroup(String, Task)")]),_v(", which finds the group with the same name and assign that task to everyone that is in the group.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 4. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addpersontogroup gn/2103T gp/Bob")]),_v(" command to add Bob to the group named \"2103T\" from the group list. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addpersontogroup")]),_v(" command calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#addPersonToGroup(String, Person)")]),_v(", which finds the group with the same name and add the person to the group.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 5. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("removepersonfromgroup gn/2103T gp/4")]),_v(" command to remove Bob from the group named \"2103T\" from the group list. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("removepersonfromgroup")]),_v(" command calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#removePersonFromGroup(String, Person)")]),_v(", which finds the group with the same name and remove the person to the group.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 6. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deletetaskgroup gn/2103T gt/Task 1")]),_v(" command to remove a task named \"Task 1\" from the group named \"2103T\" from the group list. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deletetaskgroup")]),_v(" command calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#deleteAssignedTaskGroup(String, Task)")]),_v(", which finds the group with the same name and remove that task from everyone that is in the group.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 7. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deletegroup gn/2103T")]),_v(" command to remove the group from the list. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deletegroup")]),_v(" command calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#removeGroup(String)")]),_v(", which finds the group with the same name and remove that group from the list.")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedAddressBook#commit()")]),_v(" — Saves the current address book and task list state in its history.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedAddressBook#undo()")]),_v(" — Restores the previous address book and task list state from its history.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedAddressBook#redo()")]),_v(" — Restores a previously undone address book and task list state from its history.")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("These operations are exposed in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" interface as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#commit()")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#undo()")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#redo()")]),_v(" respectively.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 1. The user launches the application for the first time. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedAddressBook")]),_v(" will be initialized with the initial address book and task list state, with the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addressBookStatePointer")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("taskListStatePointer")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 2. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/task 1 …​")]),_v(" to add a new task. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addtask")]),_v(" command also calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#commit()")]),_v(", causing another modified task kust state to be saved into the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("taskListStateList")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 3. The user now decides that adding the person was a mistake, and decides to undo that action by executing the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undo")]),_v(" command. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undo")]),_v(" command will call "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#undo()")]),_v(", which will shift the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("taskListStatePointer")]),_v(" once to the left, pointing it to the previous task list state, and restores the task list to that state.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("redo")]),_v(" command does the opposite — it calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#redo()")]),_v(", which shifts the pointers once to the right, pointing to the previously undone state, and restores the address book or task list to that state.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 4. The user then decides to execute the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("listtask")]),_v(". Commands that do not modify the task list, such as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("listtask")]),_v(", will usually not call "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#commit()")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#undo()")]),_v(" or "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#redo()")]),_v(". Thus, the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("taskListStateList")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("taskListStatePointer")]),_v(" remains unchanged.")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("has a need to manage a significant number of contacts")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")]),_v(" "),_c('li',[_v("are currently managing people for groups")]),_v(" "),_c('li',[_v("has a tendency to forget tasks to complete")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(": This app aims to help leaders to keep track of members of formed groups and their contact information. This app helps to keep track of individual and group tasks, deadlines and meetings, thus allowing them to have a better overview of the structure.")])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("student")]),_v(" "),_c('td',[_v("add personal tasks")]),_v(" "),_c('td',[_v("keep up to date with the different tasks to complete")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("student")]),_v(" "),_c('td',[_v("delete tasks")]),_v(" "),_c('td')]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("student")]),_v(" "),_c('td',[_v("mark/unmark the tasks as done/not done")]),_v(" "),_c('td',[_v("keep track of tasks that are completed")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("group leader")]),_v(" "),_c('td',[_v("assign tasks to individuals within the group")]),_v(" "),_c('td',[_v("manage individual tasks")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("busy group leader")]),_v(" "),_c('td',[_v("see an overview of all the saved task")]),_v(" "),_c('td',[_v("save time")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("student")]),_v(" "),_c('td',[_v("set deadline for my tasks")]),_v(" "),_c('td',[_v("see which task need to be done earlier")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Use case: Assigns a task")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list of contacts")])]),_v(" "),_c('li',[_c('p',[_v("TeamTracker shows a list of contacts")])]),_v(" "),_c('li',[_c('p',[_v("User requests to assign a task to a contact")])]),_v(" "),_c('li',[_c('p',[_v("TeamTracker assigns the task to the contact")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("4a. The task given does not exist.")])]),_v(" "),_c('li',[_c('p',[_v("4a1. TeamTracker shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list tasks")])]),_v(" "),_c('li',[_c('p',[_v("TeamTracker shows a list of tasks")])]),_v(" "),_c('li',[_c('p',[_v("User requests to delete a specific task in the list")])]),_v(" "),_c('li',[_c('p',[_v("TeamTracker deletes the task")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The given index is invalid.")])]),_v(" "),_c('li',[_c('p',[_v("3a1. TeamTracker shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a task to the list of tasks")])]),_v(" "),_c('li',[_c('p',[_v("TeamTracker adds to the list")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The given parameters is invalid.")])]),_v(" "),_c('li',[_c('p',[_v("2a1. TeamTracker shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("11")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("Should be able to be used for long periods without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("Should respond within one seconds.")]),_v(" "),_c('li',[_v("Documentation should be easy for users that are inexperienced in command line to follow.")]),_v(" "),_c('li',[_v("User Interface should be straightforward and intuitive to navigate even for first-time users.")]),_v(" "),_c('li',[_v("Should be able to store more than 10,000 tasks.")]),_v(" "),_c('li',[_v("Should lose no more than 1 command worth of work in case of an app crash.")]),_v(" "),_c('li',[_v("Should work without internet access.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("System admin commands")]),_v(": commands or instructions that are used through a command-line interface (CLI)\nor a terminal window")]),_v(" "),_c('li',[_c('strong',[_v("Action")]),_v(": The AddressBook processing a user command")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Thu, 11 Apr 2024, 11:06:56 GMT+8]")])])])}
}];
